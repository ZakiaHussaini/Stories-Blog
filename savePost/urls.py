...
from .views import SavedPostCheckView, SavedPostSaveView, SavedPostUnsaveView

urlpatterns = [
    path('saved-posts/check/<int:post_id>/', SavedPostCheckView.as_view(), name='saved-post-check'),
